...
if __name__ == '__main__':
    ...
    if model_select == 'pcnn':
        model = PCNN(in_feats=10, hidden_size = 32, out_feats=64, encode_dim=encode_dim, out_dim = out_dim,tras_med = tras_med,num_blcok=num_blcok,num_heads=num_heads,num_layers=num_layers).to(device)
