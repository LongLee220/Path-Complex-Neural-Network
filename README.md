...
![PCNN Architecture](data/processed/Message_Passing.png)  <!-- This path points to the PCNN model image in the data/processed directory -->

The Path Complex Neural Network Module:
![PCNN Module](data/processed/PCNN.pdf)  <!-- This path points to the PCNN model image in the data/processed directory -->
